...
state1<-c(y=42.083) #Initial state #
times1<-seq(0,4,1/10000) #4 days with 10000 intervals per day#
parameters1<-c(Y1=48.677,Y2=65.848) #Parameter values#
...
glu<-c(42.083,40.032,30.959,22.229,28.397,26.687,1.175,1.607,5.976,0.757,3.072,1.791,0.681,0.773,1.121)
