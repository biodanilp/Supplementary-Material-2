...
state1<-c(y=35.801) #Initial state #
times1<-seq(0,4,1/10000) #4 days with 10000 intervals per day#
parameters1<-c(Y1=42.780,Y2=164.63) #Parameter values#
...
glu<-c(35.801,42.651,27.468,18.88,7.776,10.549,9.333,7.429,2.737,2.474,1.952,1.167,0,0)
...
d <- ggplot() +
  ...
  labs(color = "Datos") +  # Change the title of the legend
