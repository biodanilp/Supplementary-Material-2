...
state1<-c(y=53.899) #Initial state#
times1<-seq(0,4,1/10000) #4 days with 10000 intervals per day#
parameters1<-c(Y1=60.784,Y2=82.225) #Parameter values#
#Papalexandratou et al., 2011 Ecuador <- Ecuador - WB1#
...
ODE1<-function(times,state,parameters){ 
  ...
  dy<--(Y1*U1/0.16)*y-(Y2*U2/0.16)*y #equation 
  res<-dy
  list(res)
}
